...
const UserOrderDetails = () => {
  ...
  const reviewHandler = async (e) => {
    await API.put(`/product/add-new-review`, {
      user,
      rating,
      comment,
  ...
  const refundHandler = async () => {
    await API.put(`/order/order-refund/${id}`, {
          ...
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
            ...
            <div className="w-full flex">
              ...
              <div>
                <div className="pl-3 text-[20px]">
                  {selectedItem?.name.length > 50
                    ? selectedItem?.name.slice(0, 50) + "..."
                    : selectedItem?.name}
                </div>
            ...
            <div className="w-full ml-3">
              <label className="block text-[20px] font-[500]">
                Write a comment
                <span className="ml-1 font-[400] text-[14px] text-[#00000052]">
                  (optional)
                </span>
              </label>
              <textarea
