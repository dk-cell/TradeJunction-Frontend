...
const DashboardMessages = () => {
  ...
  return (
    <div className="w-[90%] bg-white m-5 h-screen rounded overflow-y-scroll">
      {!open && (
        <>
          <h1 className="text-[30px] py-3 font-Poppins text-center ">
            All Messages
          </h1>
          {conversations &&
            ...
            return (
              <div
                className={`flex w-full my-2 ${
                  item.sender[0] === sellerId ? "justify-end" : "justify-start"
                }`}
                ref={scrollRef}
              >
                {item.sender[0] !== sellerId && (
                  <img
                    src={`${backendUrl}${userData?.avatar}`}
